    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        ?></td>
                                        <td align="center">
                                            <a target="_blank" href="rapor/pdf_nilai.php?id=<?php echo $t['kd_nilai'];?>"><button type="button" class="btn btn-danger btn-circle waves-effect waves-circle waves-float">
                ...
                <a href="rapor/pdf_nilai.php" target="_blank"><button type="button" class="btn btn-danger waves-effect" style="margin-left:10px;">
                <i class="material-icons">picture_as_pdf</i>
                <span>Cetak Semua</span></button></a>
            </div>
        </div>
        <!-- #END# Basic Examples -->
    </div>
