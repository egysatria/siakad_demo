<?php
$id = $_GET['id'];
$q = $k->query("SELECT * FROM tb_detail_kel WHERE kode = '$id'");
$t = $q->fetch_assoc();
?>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
             <?php
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <form action="akademik/detail/p_u_det_kelas.php" method="POST" enctype="multipart/form-data">
                            <div class="row clearfix">
                            <input type="hidden" name="kode" value="<?=$t['kode'];?>">
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group">
                                        <div class="form-line">
                                         <?php
                                            ...
                                            {
                                               echo '<script>
                                                        alert("Tahun Ajaran Kosong Silahkan Isi/Aktifkan Tahun Ajaran   !!");
                                            ...
                                            {
                                                ?>
                                                <input type="text" class="form-control date" name="ta" value="<?= $t['thn_ajaran']?>" readonly>
